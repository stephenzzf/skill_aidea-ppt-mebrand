...
Use these templates as the default ME brand layout library. Mix templates only when the story requires it.
...
## White-Template Business Deck Notes

Use this pattern for:
- White, spacious business pages.
- Small line icons and restrained page chrome.
- Precise footer/brand marker treatment.
