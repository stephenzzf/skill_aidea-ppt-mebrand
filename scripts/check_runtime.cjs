...
for (const relativePath of [
  ...
  "references/intake-and-confirmation.md",
  "references/advanced-rebuild-playbooks.md",
  "references/layout-templates.md",
  "references/implementation-notes.md",
  "scripts/brand_ppt_helpers.cjs",
  "scripts/generate_me2026_deck.cjs",
  "scripts/qa_me2026.cjs",
  "scripts/sync_installed.cjs",
  "scripts/check_installed.cjs",
  "scripts/inspect_pptx.py",
  "scripts/check_me2026_layout_risks.py",
  "scripts/generate_me2026_component_catalog.cjs",
